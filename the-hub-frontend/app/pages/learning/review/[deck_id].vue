    ...
    <div class="max-w-4xl mx-auto px-4 py-12">
      ...
      <div v-else-if="currentCard" class="mb-12">
        <div
          ...
          <div class="relative aspect-4/3 flex items-center justify-center p-12" v-if="currentCard">
            <div class="text-center max-w-2xl">
              ...
              <div v-if="!showAnswer" class="space-y-6">
                <div
                  class="inline-flex items-center gap-2 px-4 py-2 bg-primary/10 dark:bg-primary/20 text-primary rounded-full text-sm font-medium uppercase tracking-wide">
              ...
              <div v-else class="space-y-6">
                <div
                  class="inline-flex items-center gap-2 px-4 py-2 bg-accent/10 dark:bg-accent/20 text-accent rounded-full text-sm font-medium uppercase tracking-wide">
                  <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <div v-if="getCurrentCardRating !== undefined" class="absolute top-6 left-6">
            <div
              class="px-3 py-2 bg-primary/10 dark:bg-primary/20 text-primary rounded-xl text-xs font-medium backdrop-blur-sm">
        ...
        <div
          ...
          <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
            <button v-for="rating in [1, 2, 3, 4, 5]" :key="rating" @click="selectRating(rating)" :class="[
              ...
              <div class="text-2xl font-bold mb-2 group-hover:scale-110 transition-transform duration-200">{{ rating }}
              </div>
          ...
          <div v-if="selectedRating !== null" class="text-center mb-6">
            <div
              class="inline-flex items-center gap-2 px-6 py-3 bg-primary/10 dark:bg-primary/20 text-primary rounded-xl">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
      ...
      <div v-if="reviewedCards.size > 0"
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div class="text-center p-4 bg-background-light dark:bg-background-dark rounded-xl">
            <div class="text-3xl font-bold text-text-light dark:text-text-dark mb-1">{{ cardStore.reviewCards.length -
              reviewedCards.size }}</div>
