...
const closeAIRecommendationsModal = () => {
  showAIRecommendationsModal.value = false
}
  ...
  <div class="space-y-3">
    ...
    <div v-else class="space-y-3">
      ...
      <div v-for="task in tasks" :key="task.task_id"
        ...
        <EditTaskForm v-if="editingTask && editingTask.task_id === task.task_id" :goal-id="goalId" :task="task"
          :goal-title="''" @close="closeEditForm" @updated="onTaskUpdated" />

        <div v-else-if="showDeleteConfirm === task.task_id"
    ...
    <div class="mt-4">
      <BaseButton @click="fetchAIRecommendations" :disabled="aiLoading" variant="default" size="sm" class="w-full"
        :text="aiLoading ? 'Getting AI Recommendations...' : 'Get AI Task Recommendations'" />
    </div>
