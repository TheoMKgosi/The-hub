          ...
          <div v-for="goal in filteredGoals" :key="goal.goal_id"
            ...
            <div v-if="editingGoalId !== goal.goal_id" class="flex flex-col h-full">
              ...
              <div
                ...
                <div class="flex gap-2">
                  <BaseButton @click="startEdit(goal)" text="Edit" variant="default" size="sm" />
                  <BaseButton @click="deleteGoal(goal.goal_id)" text="Delete" variant="danger" size="sm" />
                </div>
              </div>
            </div>
            ...
            <div v-else class="flex flex-col w-full space-y-4">
              ...
              <div class="flex gap-2 pt-2 border-t border-surface-light/20 dark:border-surface-dark/20">
                <BaseButton @click="saveEdit(goal.goal_id)" text="Save" variant="primary" size="md"
                  :disabled="!editFormData.title.trim()" />
                <BaseButton @click="cancelEdit" text="Cancel" variant="default" size="md" />
              </div>
            </div>
          </div>
        </div>
