...
const docTemplate = `{
    ...
    "paths": {
                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "additionalProperties": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/models.BudgetCategory"
                                }
                            }
                        }
                    },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateBudgetCategoryRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateBudgetCategoryRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "created_at",
                        "description": "Order by field (amount, start_date, end_date, created_at)",
                        "name": "order_by",
                        "in": "query"
                    },
                    {
        ...
        "/cards/{ID}/review": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Review data with quality (0-5)",
                        "name": "review",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateDeckRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/decks/{ID}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Deck update data",
                        "name": "deck",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateDeckRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "created_at",
                        "description": "Order by field (question, answer, easiness, interval, next_review, created_at)",
                        "name": "order_by",
                        "in": "query"
                    },
                    {
        ...
        "/task-learnings": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Task learning creation data",
                        "name": "task_learning",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CreateTaskLearningRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/models.Task_learning"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/task-learnings/{ID}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Task learning update data",
                        "name": "task_learning",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateTaskLearningRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "order",
                        "description": "Order by field (order, priority, due_date, created_at)",
                        "name": "order_by",
                        "in": "query"
                    },
                    {
        ...
        "/tasks/reorder": {
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Task reorder data",
                        "name": "reorder",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.ReorderTasksRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "default": "created_at",
                        "description": "Order by field (title, created_at, updated_at, deadline, status)",
                        "name": "order_by",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateTopicRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "created_at",
                        "description": "Order by field (title, created_at, updated_at)",
                        "name": "order_by",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        "handlers.CreateBudgetCategoryRequest": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "handlers.CreateTaskLearningRequest": {
            "type": "object",
            "required": [
                "title",
                "topic_id"
        ...
        "handlers.CreateTaskRequest": {
            ...
            "properties": {
                "description": {
                    "type": "string",
                    "example": "Finish the quarterly project proposal document"
                },
                "due_date": {
                    "type": "string",
        ...
        "handlers.ReorderTasksRequest": {
            ...
            "properties": {
                "task_orders": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/handlers.TaskOrderItem"
                    }
                }
            }
        },
        ...
        "handlers.UpdateBudgetCategoryRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string",
        ...
        "handlers.UpdateTaskLearningRequest": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string",
                ...
                "title": {
                    "type": "string",
                    "example": "Updated task learning title"
                }
            }
        },
        ...
        "models.Budget": {
            ...
            "properties": {
                ...
                "income_id": {
                    "description": "optional: link budget to income",
                    "type": "integer"
                },
                "start_date": {
                    "type": "string"
        ...
        "models.Card": {
            ...
            "properties": {
                ...
                "last_review": {
                    "description": "Last time card was reviewed",
                    "type": "string"
                },
                "next_review": {
                    "description": "When the card should next appear",
                    "type": "string"
                },
                "question": {
                    "type": "string"
        ...
        "models.Topic": {
            ...
            "properties": {
                "deadline": {
                    "description": "EstimatedHours int        ` + "`" + `json:\"estimated_hours\"` + "`" + `",
                    "type": "string"
                },
                "description": {
                    "type": "string"
                ...
                "status": {
                    "description": "or use enum logic",
                    "type": "string"
                },
                "tags": {
                    "description": "Tasks          []Task_learning ` + "`" + `json:\"tasks\"` + "`" + `",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.Tag"
                    }
