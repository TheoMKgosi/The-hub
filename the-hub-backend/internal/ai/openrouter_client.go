...
func (c *OpenRouterClient) GenerateGoalTaskRecommendations(goalTitle, goalDesc string, existingTasks []string) (string, error) {
...
Generate new task recommendations for this goal. Response should be a JSON array with objects containing:
- "title": task title
- "description": task description
- "priority": 1-5 priority
- "estimated_hours": estimated hours (1-8)
- "reasoning": brief explanation

Ensure new tasks don't duplicate existing ones. Focus on actionable items.`, goalTitle, goalDesc, string(existingTasksJSON))
